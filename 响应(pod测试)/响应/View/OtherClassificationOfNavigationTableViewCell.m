//
//  OtherClassificationOfNavigationTableViewCell.m
//  响应
//
...
@implementation OtherClassificationOfNavigationTableViewCell
...
- (void)setSelectedRow:(NSInteger)selectedRow{
    ...
    self.navigationView.sectionCount = 1;
    self.navigationView.selectedArr = self.selectedSectionOneArr;
    
    self.navigationView.arrTitle = arr;
}
- (OtherClassificationOfNavigationCollectionView *)navigationView{
    
    if (!_navigationView) {
        _navigationView = [[OtherClassificationOfNavigationCollectionView alloc]init];
