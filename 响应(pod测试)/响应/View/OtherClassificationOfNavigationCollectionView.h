//
//  OtherClassificationOfNavigationCollectionView.h
//  响应
//
...
@interface OtherClassificationOfNavigationCollectionView : UIView<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>

@property(nonatomic,strong)UICollectionView * otherClassificationOfNavigationView;
