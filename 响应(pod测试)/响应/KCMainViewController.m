...
//  响应
//
//  Created by  open-roc on 2017/11/25.
...
-(void)setDefaultImage{
    //加载默认图片
    _leftImageView.image=[UIImage imageNamed:[NSString stringWithFormat:@"%i",_imageCount-1]];
    _centerImageView.image=[UIImage imageNamed:[NSString stringWithFormat:@"%i",0]];
    _rightImageView.image=[UIImage imageNamed:[NSString stringWithFormat:@"%i",1]];
