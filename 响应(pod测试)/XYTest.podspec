#
#  Be sure to run `pod spec lint XYTest.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "XYTest"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of XYTest."
  ...
  spec.homepage     = "http://EXAMPLE/XYTest"
  ...
  # spec.ios.deployment_target = "8.0" #指定平台和最低支持版本
